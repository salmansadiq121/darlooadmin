            ...
            <div className="flex items-center justify-between gap-4 flex-wrap">
              <div className="relative flex-1 min-w-[250px]">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#c6080a] focus:border-transparent transition-all duration-200"
                />
                {searchInput && searchInput !== searchQuery && (
                  ...
                  >
                    <div className="w-2 h-2 bg-[#c6080a] rounded-full animate-pulse" />
                  </motion.div>
                )}
              </div>
              <div className="flex items-center gap-3">
